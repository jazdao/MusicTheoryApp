        ...
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.menu_main:
                        startActivity(new Intent(Practice3.this, MainActivity.class));
                        return true;

                    case R.id.menu_lessons:
                        startActivity(new Intent(Practice3.this, Lessons.class));
                        return true;

                    case R.id.menu_practice:
                        startActivity(new Intent(Practice3.this, Practice.class));
                        return true;

                    case R.id.menu_glossary:
                        startActivity(new Intent(Practice3.this, Glossary.class));
                        return true;
        ...
        choice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (choice1.getText().equals(answer)) {
                    Toast.makeText(Practice3.this, "That's correct!", Toast.LENGTH_SHORT).show();
                    correct++;
                    score = (correct / questionNum) * 100;
                }
                else {
                    Toast.makeText(Practice3.this, "Sorry, the correct answer is " + answer + ".", Toast.LENGTH_SHORT).show();
                    score = (correct / questionNum) * 100;
                }
                updateQuestion();
            }
